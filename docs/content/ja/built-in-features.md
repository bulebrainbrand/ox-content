...
| 独自ホストの SSG 出力 | `planSsgOutputs`、`writeResourceFiles`、`writeMarkdownCompanions`、`writeFeedFiles`、`writeSiteMapFiles`                                                                                                  | 公開 API           | [SSG 出力プリミティブ](./built-in/ssg-output.md)         |
...
| オプトイン埋め込み    | `embeds.pm`, `embeds.twitter`, `embeds.reddit`, `embeds.bluesky`, `embeds.spotify`, `embeds.appleMusic`, `embeds.speakerDeck`, `embeds.audio`, `embeds.video`, `embeds.stackBlitz`, `embeds.webContainer` | `false`            | [埋め込み](./built-in/embeds.md)                         |
...
| データテーブル        | `dataTables`                                                                                                                                                                                              | `false`            | [データテーブル](./built-in/data-tables.md)              |
